import { ArrowDownIcon, ArrowUpIcon, UserIcon } from '@heroicons/react/20/solid'
import { CursorArrowRaysIcon, EnvelopeOpenIcon } from '@heroicons/react/24/outline';



const stats = [
    { id: 1, name: 'Total Subscribers', stat: '71,897', icon: UserIcon, change: '122', changeType: 'increase' },
...
const StatCard  = ({item}) => {
    ...
    return (
        <div>
          ...
          <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-6">
              <div
                key={item.id}
