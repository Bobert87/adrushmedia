...
const advertisersData = require("../../data/advertisers.json");
...
async function main() {
	...
	const campaignFixedDate = campaignsData.map((campaign) => {
		return {
			...campaign,
	...
	const assetsArray = [
			...
			assetDetails: {
				create: [
					...
					{ field: "name", type: "STRING", value: "Big Panda" },
					{
						field: "address",
						type: "STRING",
						value: "Roosevelt Ave, Zona 11 , GT",
					},
			...
			assetDetails: {
				create: [
					...
					{ field: "postalCode", type: "STRING", value: "01009" },
					{
						field: "description",
						type: "STRING",
						value: "Sake Bar Near Reforma Avenue",
					},
					{ field: "latitude", type: "FLOAT", value: "14.5895 " },
					{ field: "longitude", type: "FLOAT", value: "-90.5518" },
				],
			...
			assetDetails: {
				create: [
					...
					{ field: "name", type: "STRING", value: "Galavista Las Americas" },
					{
						field: "address",
						type: "STRING",
						value: "Las Americas Ave, Zona 14 , GT",
					},
					{ field: "city", type: "STRING", value: "Guatemala City" },
					{ field: "state", type: "STRING", value: "Guatemala" },
					{ field: "country", type: "STRING", value: "Guatemala" },
					{ field: "postalCode", type: "STRING", value: "01014" },
					{
						field: "description",
						type: "STRING",
						value: "Las Americas Galavista is a popular mall in the city",
					},
					{ field: "latitude", type: "FLOAT", value: "14.5895" },
					{ field: "longitude", type: "FLOAT", value: "-90.5518" },
				],
			...
			assetDetails: {
				create: [
					...
					{ field: "postalCode", type: "STRING", value: "01009" },
					{
						field: "description",
						type: "STRING",
						value: "La Reforma bus stop is a popular site in the city",
					},
					{ field: "latitude", type: "FLOAT", value: "14.5895" },
					{ field: "longitude", type: "FLOAT", value: "-90.5518" },
				],
			...
			assetDetails: {
				create: [
					...
					{ field: "postalCode", type: "STRING", value: "01011" },
					{
						field: "description",
						type: "STRING",
						value: "Roosevelt bus stop is a popular site in the city",
					},
					{ field: "latitude", type: "FLOAT", value: "14.5895" },
					{ field: "longitude", type: "FLOAT", value: "-90.5518" },
				],
			...
			assetDetails: {
				create: [
					...
					{ field: "postalCode", type: "STRING", value: "01014" },
					{
						field: "description",
						type: "STRING",
						value: "Las Americas bus stop is a popular site in the city",
					},
					{ field: "latitude", type: "FLOAT", value: "14.5895" },
					{ field: "longitude", type: "FLOAT", value: "-90.5518" },
				],
		...
		},
		{
			...
			description:
				"White Toyota Corolla LE 2021 with license plate 123-456 and vin 1234567890",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Black Honda Civic LX 2009 with license plate 123-457 and vin 1234567891",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Ford Fusion SE 2020 with license plate 123-458 and vin 1234567892",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Red Chevrolet Malibu LT 2018 with license plate 123-459 and vin 1234567893",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Silver Nissan Altima S 2000 with license plate 123-460 and vin 1234567894",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Gray Hyundai Sonata SE 2015 with license plate 123-461 and vin 1234567895",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"White Kia Sportage LX 2021 with license plate 123-462 and vin 1234567896",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Black Volkswagen Passat S 2021 with license plate 123-463 and vin 1234567897",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Blue Subaru Legacy Base 2017 with license plate 123-464 and vin 1234567898",
			assetDetails: {
				create: [
		...
		},
		{
			...
			description:
				"Red Isuzu DMax Sport 2015 with license plate 123-465 and vin 1234567899",
			assetDetails: {
				create: [
		...
		data: [
			{
				name: "Zona 15",
				coordinates: [
					-90.5041557, 14.6099979, -90.4957443, 14.5874056, -90.4837682,
					14.5781316, -90.47879, 14.5873519, -90.4872443, 14.5920449,
					-90.4902055, 14.5948275, -90.4911496, 14.6006002, -90.4976727,
					14.6062066, -90.4990585, 14.6154844, -90.5108173, 14.6184327,
					-90.5109889, 14.6121622, -90.5041557, 14.6099979,
				],
			},
			{
				name: "Zona 10",
				coordinates: [
					-90.5132572, 14.6168462, -90.5154888, 14.6099527, -90.5206387,
					14.5941716, -90.5049316, 14.5896032, -90.4924862, 14.5744021,
					-90.4903404, 14.5790539, -90.5029575, 14.5932579, -90.5000393,
					14.5992383, -90.5033009, 14.6079593, -90.5095665, 14.6108663,
					-90.5064766, 14.6159326, -90.5132572, 14.6168462,
				],
			},
			{
				name: "Zona 7",
				coordinates: [
					-90.5653595, 14.6402657, -90.5604672, 14.6343695, -90.5478501,
					14.6337051, -90.540297, 14.6349508, -90.534203, 14.6376083,
					-90.5245041, 14.6339543, -90.5229592, 14.6431722, -90.5263924,
					14.6509781, -90.5354904, 14.6501477, -90.5431294, 14.6445009,
					-90.5622696, 14.6410131, -90.5653595, 14.6402657,
				],
			},
			{
				name: "Zona 14",
				coordinates: [
					-90.5201267, 14.5902676, -90.5196118, 14.5939223, -90.5268215,
					14.5775586, -90.5322289, 14.5619413, -90.5266499, 14.558203,
					-90.5184101, 14.5679225, -90.5062222, 14.581878, -90.5138611,
					14.5919288, -90.5201267, 14.5902676,
				],
			},
			{
				name: "Rosevelt",
				coordinates: [
					...
					-90.5809278, 14.6356771, -90.5954332, 14.6363415, -90.5981798,
					14.6368397, -90.5981798, 14.6330196, -90.5712289, 14.6317739,
					-90.5573168, 14.6255249,
				],
			},
		],
	});
