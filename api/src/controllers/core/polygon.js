...
class Polygon {
    ...
    async create(req, res) {
        try {
            ...
            if (polygon.points.length < 2) throw new Error('Polygon must have at least 2 points');
            if (polygon.points.length % 2 !== 0) throw new Error('Polygon must have an even number of points');
